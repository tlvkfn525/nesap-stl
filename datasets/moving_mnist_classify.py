...
def get_datasets(data_dir, n_train=None, n_valid=None, **kwargs):
    ...
    train_data = MovingMNIST(os.path.join(data_dir, 'moving-mnist-classify-train.npz'),
                             n_samples=n_train, **kwargs)
    valid_data = MovingMNIST(os.path.join(data_dir, 'moving-mnist-classify-valid.npz'),
